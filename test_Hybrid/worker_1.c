    ...
    while(1)
    {
        ...
        if (tmp == 1)
        {
            ...
            */
            ...
            {
                sum++;
                printf("countSDF%d:worker%d_outside1:show recv, recv[0][0] is %d, recv[50][50] is %d, recv[149][149] is %d\n", sum, my_rank, tmp_address[0], tmp_address[1000 * 2250 + 1000], tmp_address[0]);
            }
