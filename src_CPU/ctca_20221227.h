...
extern int CTCAR_buffer_init_int(int buffersize_tmp, int dimensionsize_tmp, int *loaded_data_address_tmp, int *grid_number, int *data_size_total, int policy);
extern int CTCAR_buffer_init_real4(int buffersize_tmp, int dimensionsize_tmp, float *loaded_data_address_tmp, int *grid_number, int *data_size_total);
extern int CTCAR_buffer_init_real8(int buffersize_tmp, int dimensionsize_tmp, double *loaded_data_address_tmp, int *grid_number, int *data_size_total);
extern int CTCAC_buffer_init();
extern int CTCAW_buffer_init(int *grid_number, int *data_size_total, int *data_address_tmp);

extern int CTCAR_buffer_load_data();
extern int CTCAW_buffer_read_data();

extern int CTCAR_buffer_over();
...
extern void* CTCAW_buffer_get_address();
