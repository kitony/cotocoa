...
static int requester_buffer_init(int buffersize_byte, int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp, int type)
{
    int datasize_tmp = 1;
    int color = 0;
    int i;
    ...
    switch (type) {
        case DAT_INT:
        buffersize = (buffersize_byte / sizeof(int)) * 1024;
        ...
        break;
        case DAT_REAL4:
        buffersize = (buffersize_byte / sizeof(float)) * 1024;
        ...
        break;
        case DAT_REAL8:
        buffersize = (buffersize_byte / sizeof(double)) * 1024;
...
int CTCAR_buffer_init_int_buffersize(int buffersize_byte, int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
    ...
    requester_buffer_init(buffersize_byte, dimensionsize_tmp, location_start_tmp, location_end_tmp, DAT_INT);
}

int CTCAR_buffer_init_real4_buffersize(int buffersize_byte, int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
    ...
    requester_buffer_init(buffersize_byte, dimensionsize_tmp, location_start_tmp, location_end_tmp, DAT_REAL4);
}

int CTCAR_buffer_init_real8_buffersize(int buffersize_byte, int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
    ...
    requester_buffer_init(buffersize_byte, dimensionsize_tmp, location_start_tmp, location_end_tmp, DAT_REAL8);
}

int CTCAR_buffer_init_int(int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
        fprintf(stderr, "%d : CTCAR_buffer_init_int() : ERROR : wrong role %d\n", world_myrank, myrole);
    ...
    requester_buffer_init(1024 * 1024 * 1024, dimensionsize_tmp, location_start_tmp, location_end_tmp, DAT_INT);
}

int CTCAR_buffer_init_real4(int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
        fprintf(stderr, "%d : CTCAR_buffer_init_real4() : ERROR : wrong role %d\n", world_myrank, myrole);
    ...
    requester_buffer_init(1024 * 1024 * 1024, dimensionsize_tmp, location_start_tmp, location_end_tmp, DAT_REAL4);
}

int CTCAR_buffer_init_real8(int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
        fprintf(stderr, "%d : CTCAR_buffer_init_real8() : ERROR : wrong role %d\n", world_myrank, myrole);
    ...
    requester_buffer_init(1024 * 1024 * 1024, dimensionsize_tmp, location_start_tmp, location_end_tmp, DAT_REAL8);
}
...
static int worker_buffer_init(int loop_number_tmp, int *recv_location_start, int *recv_location_end, int type)
{
    int i,j;
    int color = 1;
    residue = 0;
...
int CTCAW_buffer_init_int(int loop_number_tmp, int *recv_location_start, int *recv_location_end)
{
    if (myrole != ROLE_WRK)
    {
    ...
    worker_buffer_init(loop_number_tmp, recv_location_start, recv_location_end, DAT_INT);
}

int CTCAW_buffer_init_real4(int loop_number_tmp, int *recv_location_start, int *recv_location_end)
{
    if (myrole != ROLE_WRK)
    {
    ...
    worker_buffer_init(loop_number_tmp, recv_location_start, recv_location_end, DAT_REAL4);
}

int CTCAW_buffer_init_real8(int loop_number_tmp, int *recv_location_start, int *recv_location_end)
{
    if (myrole != ROLE_WRK)
    {
    ...
    worker_buffer_init(loop_number_tmp, recv_location_start, recv_location_end, DAT_REAL8);
}
...
int* get_address(int *receiver_address)
{
...
static int worker_buffer_get_data(int *receiver_address)
{
    printf("bad\n");
    if (residue > 0)
    {
...
int CTCAW_buffer_get_data_int(int *receiver_address)
{
    if (myrole != ROLE_WRK)
    {
        fprintf(stderr, "%d : CTCAW_buffer_get_data_int() : ERROR : wrong role %d\n", world_myrank, myrole);
        return 0;
    }
    return worker_buffer_get_data(receiver_address);
}

int CTCAW_buffer_get_data_real4(float *receiver_address)
{
    if (myrole != ROLE_WRK)
    {
        fprintf(stderr, "%d : CTCAW_buffer_get_data_real4() : ERROR : wrong role %d\n", world_myrank, myrole);
        return 0;
    }
    return worker_buffer_get_data((void *)receiver_address);
}

int CTCAW_buffer_get_data_real8(double *receiver_address)
{
    if (myrole != ROLE_WRK)
    {
        fprintf(stderr, "%d : CTCAW_buffer_get_data_real8() : ERROR : wrong role %d\n", world_myrank, myrole);
        return 0;
    }
    return worker_buffer_get_data((void *)receiver_address);
}
...
int CTCAW_buffer_free()
{
    ...
    if (subrank_table[world_myrank] == 0)
    {
        printf("the rank %d, the time is %f\n", world_myrank, time_total);
    }
    MPI_Barrier(MPI_COMM_WORLD);
    MPI_Win_unlock_all(win_data);
    MPI_Win_unlock_all(win_count_requester);
