...
static int requester_buffer_init(int buffersize_tmp, int dimensionsize_tmp, void *data_address_tmp, int *req_location_start_tmp, int *req_location_end_tmp, int type)
{
    ...
    {
        datasize_tmp = datasize_tmp * (req_location_end_tmp[i] - req_location_start_tmp[i]);
    }
    ...
    */
    ...
    switch (type) {
        ...
        (int *)data_address;
        data_address = (int *)data_address_tmp;
        ...
        (float *)data_address;
        data_address = (float *)data_address_tmp;
        ...
        (double *)data_address;
        data_address = (double *)data_address_tmp;
...
int CTCAR_buffer_init_int(int buffersize_tmp, int dimensionsize_tmp, int *data_address_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
    ...
    requester_buffer_init(buffersize_tmp, dimensionsize_tmp, (void *)data_address_tmp, location_start_tmp, location_end_tmp, DAT_INT);
}

int CTCAR_buffer_init_real4(int buffersize_tmp, int dimensionsize_tmp, float *data_address_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
    ...
    requester_buffer_init(buffersize_tmp, dimensionsize_tmp, (void *)data_address_tmp, location_start_tmp, location_end_tmp, DAT_REAL4);
}

int CTCAR_buffer_init_real8(int buffersize_tmp, int dimensionsize_tmp, double *data_address_tmp, int *location_start_tmp, int *location_end_tmp)
{
    if (myrole != ROLE_REQ)
    {
    ...
    requester_buffer_init(buffersize_tmp, dimensionsize_tmp, (void *)data_address_tmp, location_start_tmp, location_end_tmp, DAT_REAL8);
}
...
static int worker_buffer_init(int *wrk_location_start, int *wrk_location_end, int method)
{
...
int CTCAW_buffer_init(int *recv_location_start, int *recv_location_end, int policy)
{
    if (myrole != ROLE_WRK)
    {
    ...
    worker_buffer_init(recv_location_start, recv_location_end, policy);
}
