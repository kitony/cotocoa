...
extern int CTCAR_buffer_init_int(int *special_buffer, int buffersize_tmp, int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp, volatile int *count_requester, volatile int *count_worker);
extern int CTCAR_buffer_init_real4(float *special_buffer, int buffersize_tmp, int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp, volatile int *count_requester, volatile int *count_worker);
extern int CTCAR_buffer_init_real8(double *special_buffer, int buffersize_tmp, int dimensionsize_tmp, int *location_start_tmp, int *location_end_tmp, volatile int *count_requester, volatile int *count_worker);
extern int CTCAC_buffer_init_int();
extern int CTCAW_buffer_init_int(int buffersize_tmp, int loop_number_tmp, int *recv_location_start, int *recv_location_end, volatile int *count_requester, volatile int *count_worker);
extern int CTCAW_buffer_init_real4(int buffersize_tmp, int loop_number_tmp, int *recv_location_start, int *recv_location_end, volatile int *count_requester, volatile int *count_worker);
extern int CTCAW_buffer_init_real8(int buffersize_tmp, int loop_number_tmp, int *recv_location_start, int *recv_location_end, volatile int *count_requester, volatile int *count_worker);
extern int CTCAR_load_data_int(int *special_buffer, int *loaded_data, volatile int *count_requester, volatile int *count_worker);
extern int CTCAR_load_data_real4(float *special_buffer, float *loaded_data, volatile int *count_requester, volatile int *count_worker);
extern int CTCAR_load_data_real8(double *special_buffer, double *loaded_data, volatile int *count_requester, volatile int *count_worker);
extern int CTCAW_get_data_int(int *receiver_buffer, volatile int *count_requester, volatile int *count_worker);
extern int CTCAW_get_data_real4(float *receiver_buffer);
extern int CTCAW_get_data_real8(double *receiver_buffer);
