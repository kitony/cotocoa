...
int requester_buffer_load_data_nosuspend()
{
    ...
    switch (buffer_type) {
        case DAT_INT:
        memcpy(special_buffer + datasize[subrank_table[world_myrank]] * mod_number, data_address, datasize[subrank_table[world_myrank]] * sizeof(int));
        break;
        case DAT_REAL4:
        memcpy(special_buffer + datasize[subrank_table[world_myrank]] * mod_number, data_address, datasize[subrank_table[world_myrank]] * sizeof(float));
        break;
        case DAT_REAL8:
        memcpy(special_buffer + datasize[subrank_table[world_myrank]] * mod_number, data_address, datasize[subrank_table[world_myrank]] * sizeof(double));
        break;
    }
