...
int main()
{
    ...
    */
    ...
    CTCAW_buffer_init_int(1000, start, end, 1);
    while(1)
    { 
        ...
        if (tmp == 1)
        {
            ...
            //do calculation
            //calculation();
            if (my_rank >= 10 && my_rank <= 13)
            {
                printf("worker%d_outside1:%d, %d, %d, %d, %d, %d, %d, %d\n",
                my_rank, tmp_address[0], tmp_address[500], tmp_address[1000], tmp_address[1500], tmp_address[499 * 1500], tmp_address[500 * 1500], tmp_address[999 * 1500], tmp_address[1000 * 1500]);
            }
